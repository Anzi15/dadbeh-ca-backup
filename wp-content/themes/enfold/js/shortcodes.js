(function ($) {
  ...
  function activate_shortcode_scripts(container) {
    ...
    if ($.fn.aviaVideoApi) {
      $(
        '.avia-slideshow iframe[src*="youtube.com"], .av_youtube_frame, .avia-slideshow iframe[src*="vimeo.com"], .avia-slideshow video'
      ).aviaVideoApi({}, "li");
    }
  ...
  (function ($) {
    ...
    $.AviaMapsAPI = function (options, container) {
      if (typeof window.av_google_map == "undefined") {
        $.avia_utilities.log(
          "Map creation stopped, var av_google_map not found"
        );
        return;
      }
    ...
    $.AviaMapsAPI.prototype = {
      ...
      _getAPI: function () {
        ...
        if (
          ...
          $.AviaMapsAPI.apiFiles.loading == false
        ) {
          ...
          if (
            avia_framework_globals.gmap_api != "undefined" &&
      ...
      _bind_execution: function () {
        this.$body.on(
          "av-google-maps-api-loaded",
          $.proxy(this._applyMap, this)
        );
      },
      ...
      _applyMap: function () {
        ...
        var _self = this,
          mobile_drag = $.avia_utilities.isMobile
            ? this.$data.mobile_drag_control
            : true,
        ...
        for (var key in this.$data.marker) {
          bounds.extend(
            new google.maps.LatLng(
              this.$data.marker[key].lat,
              this.$data.marker[key].long
            )
          );
        }
          ...
          (function (key, _self) {
            setTimeout(function () {
              ...
              if (
                ...
                !_self.$data.marker[key].long ||
                !_self.$data.marker[key].long
              ) {
                $.avia_utilities.log(
                  "Latitude or Longitude for single marker missing",
                  "map-error"
                );
                return;
              }

              _self.$data.LatLng = new google.maps.LatLng(
                _self.$data.marker[key].lat,
                _self.$data.marker[key].long
              );
              ...
              if (
                _self.$data.marker[key].icon &&
                _self.$data.marker[key].imagesize
              ) {
                ...
                markerArgs.icon = new google.maps.MarkerImage(
                  _self.$data.marker[key].icon,
                  null,
                  null,
                  half,
    ...
    $.AviaVideoAPI.prototype = {
      ...
      _bindEvents: function () {
        if (
          ...
          typeof this.eventsBound == "undefined"
        ) {
          return;
        }
        ...
        methods = {
          ...
          control_click: function () {
            ...
            switch (this.hash) {
              case "#next":
                showItem = active
                  .nextAll(".post-entry:visible:eq(0)")
                  .find("a:eq(0)");
                if (!showItem.length) {
                  showItem = $(".post-entry:visible:eq(0)", container).find(
                    "a:eq(0)"
                  );
                }
              ...
              case "#prev":
                showItem = active
                  .prevAll(".post-entry:visible:eq(0)")
                  .find("a:eq(0)");
                if (!showItem.length) {
                  showItem = $(".post-entry:visible:last", container).find(
                    "a:eq(0)"
                  );
                }
                showItem.trigger("click");
  ...
  $.AviaFullscreenSlider.prototype = {
    _init: function (options) {
      ...
      this.options.parallax_enabled =
        this.$slider.data("image_attachment") == "" ? true : false;
  ...
  $.AviaParallaxElement.prototype = {
    _init: function (options) {
      ...
      this.$win.on(
        ...
        $.proxy(_self._fetch_properties, _self)
      );
      this.$body.on(
        "av_resize_finished",
        $.proxy(_self._fetch_properties, _self)
    ...
    _fetch_properties: function () {
      ...
      this.$el.height(
        Math.ceil(this.property.wh * this.ratio + this.property.height)
      );
    ...
    _parallax_scroll: function (e) {
      ...
      if (
        this.property.offset < winBottom &&
        winTop <= this.property.offset + this.property.height
      ) {
  ...
  $.fn.avia_browser_height = function () {
    ...
    var win = $(window),
      ...
      calc_height = function () {
        ...
        css +=
          ".av-minimum-height-100 .container, .avia-fullscreen-slider .avia-slideshow, #top.avia-blank .av-minimum-height-100 .container, .av-cell-min-height-100 > .flex_cell{height:" +
          wh100 +
          "px;}\n";
        css +=
          ".av-minimum-height-75 .container, .av-cell-min-height-75 > .flex_cell	{height:" +
          wh75 +
          "px;}\n";
        css +=
          ".av-minimum-height-50 .container, .av-cell-min-height-50 > .flex_cell	{height:" +
          wh50 +
          "px;}\n";
        css +=
          ".av-minimum-height-25 .container, .av-cell-min-height-25 > .flex_cell	{height:" +
          wh25 +
          "px;}\n";
        css +=
          ".avia-builder-el-0.av-minimum-height-100 .container, .avia-builder-el-0.avia-fullscreen-slider .avia-slideshow, .avia-builder-el-0.av-cell-min-height-100 > .flex_cell{height:" +
          wh100_mod +
          "px;}\n";
      ...
      heading.each(function (i) {
        ...
        thisheading.on("click", function () {
          if (content.css("visibility") != "hidden") {
            ...
            content.addClass("active_tc").slideDown(
              200,
    ...
    return this.each(function () {
      ...
      function open_content(tab, i, alternate_tab) {
        if (!tab.is("." + options.active)) {
          ...
          $("." + options.active + "_content", container).removeClass(
            options.active + "_content"
          );
        ...
        change_tab = function (e) {
          ...
          var new_bg = current_content.data("av-tab-bg-color"),
            ...
            prev_container = container
              ...
              .not('[data-av-tab-section-content="' + tab_nr + '"]');
          ...
          if (cssActive) {
            ...
            transition["transform"] = transform3d
              ...
              : "translate(" + new_pos + "%,0)"; //3d or 2d transform?
            transition["left"] = "0%";
      ...
      var container = $(this),
        ...
        change_active = function (index) {
          ...
          var current = slide_element.find(options.slide_content).eq(index),
            ...
            modifier =
              container.data("av-enlarge") > 1 && currentIndex == index
                ? container.data("av-enlarge")
                : 1,
  ...
  (function ($) {
    ...
    $.fn.avia_sc_animated_number = function (options) {
      ...
      var skipStep = false,
        ...
        start_timer =
          options && options.start_timer ? options.start_timer : 300,
      ...
      this.$slides.removeClass("aviaccordion-active-slide").each(function (i) {
        ...
        if (_self.cssActive) {
          ...
          transition[_self.property] = _self.transform3d
            ...
            : "translate(" + trans_val + "%,0)"; //3d or 2d transform?
...
(function ($) {
  ...
  $.AviaSlider.prototype = {
    _init: function (options) {
      ...
      } //if it was a default slider all images are already loaded and we can start showing the slider
      else {
    ...
    _navigate: function (dir, pos) {
      ...
      // if not check the boundaries
        ...
        if (
          this.current === 0 &&
          this.options.autoplay_stopper == 1 &&
      ...
      } //no background loader -> images are already loaded
      else {
    ...
    _slide: function (dir) {
      ...
      if (this.cssActive) {
        ...
        } //do a 2d transform. still faster than a position "left" change
        else {
      ...
      self.$slides.each(function (i) {
        ...
        if (currentSlide.data("avia_video_events") != true) {
          ...
          currentSlide.on(
            ...
            { slide: currentSlide, wrap: mejs, iteration: i, self: self },
            onReady
          );
